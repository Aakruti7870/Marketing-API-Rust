use crate::auth::jwt::{generate_access_token, verify_token, AuthTokens};
...
pub async fn register(
    ...
    sqlx::query!(
        "INSERT INTO refresh_tokens (id, token, user_id, family, expires_at)
         VALUES ($1, $2, $3, $4, $5)",
        Uuid::new_v4(),
...
pub async fn refresh(
    ...
    // If an already revoked token is used, revoke the entire token family!
